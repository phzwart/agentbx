...
@click.command()
@click.option('--list-only', '-l', is_flag=True, help='Only list bundles, do not delete')
@click.option('--keep-latest', '-k', is_flag=True, help='Keep only the latest bundle of each type')
