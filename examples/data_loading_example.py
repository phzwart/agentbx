...
from agentbx.utils.data_loader import DataLoader, load_macromolecule, load_experimental_data, load_both_data
...
def main():
    ...
    try:
        ...
        for bundle_info in all_bundles:
            logger.info(f"Bundle: {bundle_info['bundle_id']} ({bundle_info['bundle_type']})")
