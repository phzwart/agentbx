...
class GradientAgent(SinglePurposeAgent):
    ...
    def process_bundles(self, input_bundles: Dict[str, Bundle]) -> Dict[str, Bundle]:
        ...
        if target_sf_grads is None:
            raise ValueError("Target data must contain gradients w.r.t. structure factors")
    ...
    def _calculate_sf_gradients_wrt_coords(self, sf_data, atomic_data):
        """
    ...
    def _apply_chain_rule_coordinates(self, dt_df, df_dx):
        """
        Apply chain rule: dT/dx = dT/dF * dF/dx
    ...
    def _compute_gradient_metadata(self, coordinate_gradients):
        """
    ...
    def _finite_difference_test(self, atomic_data, target_data, delta=1e-6):
        """
