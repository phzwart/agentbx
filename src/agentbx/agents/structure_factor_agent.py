...
class StructureFactorAgent(SinglePurposeAgent):
    ...
    def _calculate_f_calc(self, xray_structure, miller_indices):
        """
        ...
        try:
            ...
            logger.info(f"Selected {f_calc_selected.size()} reflections matching input miller indices")
    ...
    def _calculate_f_mask(self, xray_structure, miller_indices, bulk_params):
        """
    ...
    def _combine_structure_factors(self, f_calc, f_mask, bulk_params):
        """
