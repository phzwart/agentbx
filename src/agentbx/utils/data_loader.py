...
from ..core.processors.macromolecule_processor import MacromoleculeProcessor
from ..core.processors.experimental_data_processor import ExperimentalDataProcessor
from ..utils.crystallographic_utils import CrystallographicFileHandler
...
class DataLoader:
    ...
    def __init__(self, redis_manager: RedisManager):
        ...
        self.macromolecule_processor = MacromoleculeProcessor(redis_manager, "data_loader_macro")
        self.experimental_processor = ExperimentalDataProcessor(redis_manager, "data_loader_exp")
    ...
    def load_macromolecule(self, pdb_file: str) -> str:
        ...
        try:
            ...
            bundle_id = self.macromolecule_processor.create_macromolecule_bundle(pdb_file)
    ...
    def load_experimental_data(self, mtz_file: str, 
                              f_obs_label: str = "FP",
                              sigma_label: str = "SIGFP", 
                              r_free_label: str = "FreeR_flag") -> str:
        """
    ...
    def load_intensity_data(self, hkl_file: str,
                           i_obs_label: str = "I",
    ...
    def load_both_data(self, pdb_file: str, mtz_file: str,
                       f_obs_label: str = "FP",
                       sigma_label: str = "SIGFP",
                       r_free_label: str = "FreeR_flag") -> Tuple[str, str]:
        """
    ...
    def validate_data_compatibility(self, macro_bundle_id: str, exp_bundle_id: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            compatibility = {
                "unit_cell_match": str(macro_symmetry.unit_cell()) == str(exp_symmetry.unit_cell()),
                "space_group_match": str(macro_symmetry.space_group()) == str(exp_symmetry.space_group()),
            ...
            if not compatibility["unit_cell_match"]:
                logger.warning("Unit cell mismatch between macromolecule and experimental data")
                compatibility["compatible"] = False
                
            if not compatibility["space_group_match"]:
                logger.warning("Space group mismatch between macromolecule and experimental data")
                compatibility["compatible"] = False
...
def load_experimental_data(redis_manager: RedisManager, mtz_file: str,
                          f_obs_label: str = "FP",
                          sigma_label: str = "SIGFP",
                          r_free_label: str = "FreeR_flag") -> str:
    """
    ...
    """
    loader = DataLoader(redis_manager)
    return loader.load_experimental_data(mtz_file, f_obs_label, sigma_label, r_free_label)


def load_both_data(redis_manager: RedisManager, pdb_file: str, mtz_file: str,
                   f_obs_label: str = "FP",
                   sigma_label: str = "SIGFP", 
                   r_free_label: str = "FreeR_flag") -> Tuple[str, str]:
    """
    ...
    """
    loader = DataLoader(redis_manager)
    return loader.load_both_data(pdb_file, mtz_file, f_obs_label, sigma_label, r_free_label) 