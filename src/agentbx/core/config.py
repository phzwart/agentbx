...
class RedisConfig:
    ...
    def from_env(cls) -> "RedisConfig":
        ...
        return cls(
            ...
            socket_connect_timeout=int(os.getenv("AGENTBX_REDIS_SOCKET_CONNECT_TIMEOUT", "5")),
            retry_on_timeout=os.getenv("AGENTBX_REDIS_RETRY_ON_TIMEOUT", "true").lower() == "true",
            health_check_interval=int(os.getenv("AGENTBX_REDIS_HEALTH_CHECK_INTERVAL", "30")),
