...
class TestBaseClient:
    ...
    def test_store_bundle_default_id(
        self, base_client, sample_bundle, mock_redis_manager
    ):
    ...
    def test_store_bundle_custom_id(
        self, base_client, sample_bundle, mock_redis_manager
    ):
        ...
        mock_redis_manager.store_bundle.assert_called_once_with(
            sample_bundle, custom_id
        )

    def test_store_bundle_redis_error(
        self, base_client, sample_bundle, mock_redis_manager
    ):
    ...
    def test_cache_set_success(self, base_client, mock_redis_manager):
        ...
        assert result is True
        mock_redis_manager.cache_set.assert_called_once_with(
    ...
    def test_edge_case_complex_objects(self, base_client, mock_redis_manager):
        ...
        complex_obj = {
            "nested": {"list": [1, 2, 3], "tuple": (4, 5, 6), "set": {7, 8, 9}},
    ...
    def test_integration_like_workflow(
        self, base_client, mock_redis_manager, sample_bundle
    ):
